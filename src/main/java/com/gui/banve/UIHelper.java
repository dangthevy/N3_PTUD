...
public class UIHelper {
	...
	public static class DatePickerField extends JPanel {
		...
		private void showPop() {
			...
			p.setBackground(BG_CARD);
			p.setBorder(BorderFactory.createCompoundBorder(new LineBorder(BORDER, 1),
		...
		private void fillGrid() {
			...
			boolean sm = today.get(Calendar.MONTH) == cal.get(Calendar.MONTH)
	...
	public static JPanel wrapInPanel(JComponent comp) {
